...
import { SandboxSettings } from "@/components/admin/sandbox-settings"
...
export default function EditModelPage({ params }: { params: { id: string } }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-8">
        <h2 className="text-2xl font-bold mb-4">Sandbox Settings</h2>
        <SandboxSettings
          modelId={params.id}
          initialEnabled={modelData.sandbox_enabled || false}
          initialMaxUsage={modelData.sandbox_max_usage_per_user || 10}
        />
      </div>
    </motion.div>
  )
