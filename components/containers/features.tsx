import FeatImg1 from "@/public/features-1.png";
import FeatImg2 from "@/public/features-2.png";
import FeatImg3 from "@/public/features-3.png";
import FeatImg4 from "@/public/features-4.png";
  ...
  return (
    <section className="pt-32 pb-12 space-y-16">
      <div className="container flex flex-col items-center text-center gap-4">
        ...
        <p className="text-muted-foreground text-lg lg:w-2/3">
