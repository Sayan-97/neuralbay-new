import Img1 from "@/public/unlocking-img-1.png";
import Img2 from "@/public/unlocking-img-2.png";
import Img3 from "@/public/unlocking-img-3.png";
import BGImg from "@/public/unlocking-bg.png";
import BGImgSm from "@/public/unlocking-bg-sm.png";
          ...
          {data.map((item, index) => (
            ...
            >
              <div className="bg-[linear-gradient(180deg,#12113D_21%,#070232_100%)] flex flex-col lg:flex-row items-center gap-8 p-4 lg:p-12 rounded-[40px]">
                <Image src={item.img} alt="img" width={54} height={54} />
