...
import BgImg from "@/public/genesis-bg.png";
import Image from "next/image";
import ActImg1 from "@/public/activity-img-1.png";
import ActImg2 from "@/public/activity-img-2.png";
import ActImg3 from "@/public/activity-img-3.png";
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="flex flex-col items-start gap-8">
              ...
              <p className="max-lg:text-center text-muted-foreground lg:text-lg">
                {item.des}
              </p>
            </div>
            <Image src={item.img} alt="img" width={599} height={463} />
          </div>
        ))}
      </div>
    </section>
